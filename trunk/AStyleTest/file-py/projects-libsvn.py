...
def process_files():
	...
	projects_directories = get_directories(projects_directories, projects_path)
	libsvn_directories = get_directories(libsvn_directories, libsvn_path)
...
def is_svn_directory(directory_name):
	...
	if (directory_name == "AStyle"
			or directory_name[0:7] == "AStyle\\"
			or directory_name[0:9] == "AStyleDev"
			or directory_name[0:10] == "AStyleTest"
			or directory_name[0:9] == "AStyleWeb"):
		return 1
	return 0
