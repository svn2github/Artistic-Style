...
::%progdir%\AStyle.exe   -R  "%testdata%\SharpDevelop\src\*.cpp"
::if errorlevel 1 pause

REM name of the output file
set errfile="%USERPROFILE%\Documents\#d-diff.txt"

if exist %errfile% del %errfile%

echo Compare SharpDevelop files to  SharpDevelopOLD >> %errfile%
echo ---------------------------------------------- >> %errfile%
