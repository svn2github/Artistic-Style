...
@%binpath%\tlib.exe /C /P32 bin\gtestd.lib + "objGTd\gtest\src\gtest-filepath.obj" + "objGTd\gtest\src\gtest-port.obj" + "objGTd\gtest\src\gtest-test-part.obj" +   "objGTd\gtest\src\gtest-typed-test.obj" + "objGTd\gtest\src\gtest.obj" + "objGTd\gtest\src\gtest-death-test.obj"
